...
SERVICES = [
    ...
    {'name': 'Assemble SIP', 'application': 'Fornax',
     ...
     'plugin': 0, 'method': 'POST', 'callback_service': 'Start Transfer', 'post_service': None},
    {'name': 'Start Transfer', 'application': 'Fornax',
     ...
     'plugin': 0, 'method': 'POST', 'callback_service': 'Approve Transfer', 'post_service': None},
    ...
    {'name': 'Store Package', 'application': 'Gemini',
     ...
     'plugin': 0, 'method': 'POST', 'callback_service': None, 'post_service': 'Store Package Data'},
    {'name': 'Store Package Data', 'application': 'Aquarius',
     ...
     'plugin': 0, 'method': 'POST', 'callback_service': 'Process Accessions', 'post_service': None},
    {'name': 'Process Accessions', 'application': 'Aquarius',
     ...
     'plugin': 0, 'method': 'POST', 'callback_service': 'Process Grouping Components', 'post_service': None},
    {'name': 'Process Grouping Components', 'application': 'Aquarius',
     ...
     'plugin': 0, 'method': 'POST', 'callback_service': 'Process Transfer Components', 'post_service': None},
    {'name': 'Process Transfer Components', 'application': 'Aquarius',
     ...
     'plugin': 0, 'method': 'POST', 'callback_service': 'Process Digital Objects', 'post_service': None},
