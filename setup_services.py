...
SERVICES = [
    ...
    {'name': 'Fetch ArchivesSpace Updates', 'application': 'Pisces',
     'description': 'Fetches updated data from ArchivesSpace.',
     'external_uri': 'fetch-archivesspace-updates/',
     'service_route': 'fetch/archivesspace/updates/', 'plugin': 0,
     'method': 'POST', 'callback_service': None, 'post_service': None,
     'sources': None},
    {'name': 'Fetch ArchivesSpace Deletes', 'application': 'Pisces',
     'description': 'Fetches deleted data from ArchivesSpace.',
     'external_uri': 'fetch-archivesspace-deletes/',
     'service_route': 'fetch/archivesspace/deletes/', 'plugin': 0,
     'method': 'POST', 'callback_service': None, 'post_service': None,
     'sources': None},
]
